...
type BaseIdxType arch = BaseBVType (ArchRegWidth arch)
...
mkPopcntUF :: forall arm. (KnownNat (ArchRegWidth arm), 1 <= ArchRegWidth arm)
           => Integer
           -> A.UninterpFn arm
...
mkReadMemUF :: forall arm. (KnownNat (ArchRegWidth arm), 1 <= ArchRegWidth arm)
            => Integer
            -> A.UninterpFn arm
...
mkWriteMemUF :: forall arm. (KnownNat (ArchRegWidth arm), 1 <= ArchRegWidth arm)
             => Integer
             -> A.UninterpFn arm
