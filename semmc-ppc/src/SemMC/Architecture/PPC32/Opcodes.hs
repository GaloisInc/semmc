...
baseOpcodes = map fst $(STH.attachSemantics (\(Some (Witness x)) -> show x <.> "sem") allOpcodes ["data/32/base"])
...
allSemantics = $(STH.attachSemantics (\(Some (Witness x)) -> show x <.> "sem") allOpcodes [ "data/32/base"
                                                                         , "data/32/manual"
                                                                         , "data/32/learned"
                                                                         ])
