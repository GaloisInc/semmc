...
type instance A.OperandType PPC "I32imm" = BaseBVType 64
...
type instance A.OperandType PPC "U1imm" = BaseBVType 64
type instance A.OperandType PPC "U2imm" = BaseBVType 64
type instance A.OperandType PPC "U4imm" = BaseBVType 64
type instance A.OperandType PPC "U5imm" = BaseBVType 64
type instance A.OperandType PPC "U6imm" = BaseBVType 64
type instance A.OperandType PPC "U7imm" = BaseBVType 64
type instance A.OperandType PPC "U8imm" = BaseBVType 64
