...
class (A.Architecture arch,
       ...
       HasRepr (Pseudo arch (A.Operand arch)) ShapeRepr,
  ...
  assemblePseudo :: proxy arch -> Pseudo arch o sh -> ShapedList o sh -> [A.Instruction arch]
...
instance (HasRepr ((A.Opcode arch) (A.Operand arch)) ShapeRepr,
          HasRepr ((Pseudo arch) (A.Operand arch)) ShapeRepr) =>
...
synthArbitraryOperands :: (D.ArbitraryOperands (A.Opcode arch) (A.Operand arch),
                       ...
                       => DA.Gen
                       -> SynthOpcode arch sh
                       -> IO (ShapedList (A.Operand arch) sh)
...
data SynthInstruction arch =
  forall sh . SynthInstruction (SynthOpcode arch sh) (ShapedList (A.Operand arch) sh)
